    ...
    <div className="space-y-20 pb-20 min-h-screen text-gray-900 transition-colors bg-white dark:bg-gray-950 dark:text-gray-100">
      ...
      <section className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <div className="text-4xl font-semibold text-gray-900 mb-2">20+</div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Haven User Pass Rate</p>
      ...
      <section className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="font-semibold text-gray-900 mb-4">Everything You Need to Pass</h2>
              ...
              <div className="bg-white rounded-2xl dark:bg-gray-900 p-6 transform rotate-2 hover:rotate-0 transition-transform">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4">
                    <div className="bg-green-50 rounded-xl p-4"><Trophy className="text-green-600 mb-2" size={24} /><div className="text-2xl font-semibold text-gray-900">12</div><div className="text-small text-gray-600">Mastered</div></div>
                    <div className="bg-blue-50 rounded-xl p-4"><Target className="text-blue-600 mb-2" size={24} /><div className="text-2xl font-semibold text-gray-900">85%</div><div className="text-small text-gray-600">Accuracy</div></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="font-semibold text-gray-900 mb-4">Loved by Thousands of Test Takers</h2>
          <p className="text-gray-600">Real stories from people who passed with Haven</p>
        </div>
        <TestimonialCarousel />
      </section>

      <section className="max-w-4xl mx-auto">
        <div className="text-center mb-12"><h2 className="font-semibold text-gray-900 mb-4">How It Works</h2><p className="text-gray-600">Four simple steps to test success</p></div>
        <div className="space-y-8">
          <div className="flex gap-6 items-start"><div className="flex-shrink-0 w-12 h-12 bg-teal-600 text-white rounded-full flex items-center justify-center font-semibold text-xl">1</div><div><h3 className="font-semibold text-gray-900 mb-2">Study Each Lesson</h3><p className="text-gray-600">Read through our plain-English lessons covering every topic from the official handbook. Each lesson includes key facts and memory hooks.</p></div></div>
          <div className="flex gap-6 items-start"><div className="flex-shrink-0 w-12 h-12 bg-teal-600 text-white rounded-full flex items-center justify-center font-semibold text-xl">2</div><div><h3 className="font-semibold text-gray-900 mb-2">Practice Questions</h3><p className="text-gray-600">Test yourself with realistic exam-style questions. Get instant feedback with detailed explanations for every answer.</p></div></div>
          <div className="flex gap-6 items-start"><div className="flex-shrink-0 w-12 h-12 bg-teal-600 text-white rounded-full flex items-center justify-center font-semibold text-xl">3</div><div><h3 className="font-semibold text-gray-900 mb-2">Review with Flashcards</h3><p className="text-gray-600">Reinforce your memory with interactive flashcards. Perfect for quick daily review sessions on your phone or computer.</p></div></div>
          <div className="flex gap-6 items-start"><div className="flex-shrink-0 w-12 h-12 bg-teal-600 text-white rounded-full flex items-center justify-center font-semibold text-xl">4</div><div><h3 className="font-semibold text-gray-900 mb-2">Take the Real Test</h3><p className="text-gray-600">When you've scored 80%+ on all practice questions, you're ready. Book your test and pass with confidence.</p></div></div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <div className="bg-white border-2 border-teal-300 dark:bg-gray-900 dark:border-teal-400/40 rounded-2xl p-8 relative flex flex-col">
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Haven Plus</h3>
              <div className="flex items-baseline justify-center gap-2 mb-2"><span className="text-5xl font-semibold text-gray-900">£9.99</span><span className="text-gray-600">one-time</span></div>
          ...
          <div className="bg-white border-2 border-amber-300 dark:bg-gray-900 dark:border-amber-300/50 rounded-2xl p-8 relative flex flex-col">
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Haven Premium</h3>
              <div className="flex items-baseline justify-center gap-2 mb-2"><span className="text-5xl font-semibold text-gray-900">£14.99</span><span className="text-gray-600">one-time</span></div>
            ...
            <div className="bg-amber-50 border-2 border-amber-200 rounded-xl p-4 text-center mt-auto"><p className="text-sm text-amber-900">🚀 Launching Next Month!</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div><Clock className="text-teal-600 mx-auto mb-3" size={32} /><h4 className="font-semibold text-gray-900 mb-2">Instant Access</h4><p className="text-sm text-gray-600">Start learning immediately after purchase</p></div>
          <div><Award className="text-teal-600 mx-auto mb-3" size={32} /><h4 className="font-semibold text-gray-900 mb-2">Pass Guarantee</h4><p className="text-sm text-gray-600">Complete course and fail? Get refunded</p></div>
          <div><CheckCircle2 className="text-teal-600 mx-auto mb-3" size={32} /><h4 className="font-semibold text-gray-900 mb-2">No Subscription</h4><p className="text-sm text-gray-600">One payment, lifetime access forever</p></div>
        </div>
      </section>
    </div>
  );
