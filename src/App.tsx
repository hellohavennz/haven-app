    ...
    <div className="space-y-20 pb-20">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 md:p-12 text-white overflow-hidden relative">
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link to="/content" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-900 rounded-xl font-bold hover:bg-gray-100 transition-all">
                Try It Free
                <ArrowRight size={20} />
              </Link>
            </div>
      ...
      <section className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Four simple steps to test success</p>
        </div>
      ...
      <section id="pricing" className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <div className="bg-white border-2 border-teal-300 rounded-2xl p-8 relative">
            ...
            <Link to="/paywall" className="flex items-center justify-center gap-2 w-full px-8 py-4 bg-gradient-to-r from-teal-600 to-teal-700 text-white rounded-xl font-bold text-lg hover:opacity-90 transition-all">
              Get Haven Plus
              <ArrowRight size={20} />
            </Link>
          </div>
          ...
          <div className="bg-white border-2 border-amber-300 rounded-2xl p-8 relative">
            ...
            <div className="bg-amber-50 border-2 border-amber-200 rounded-xl p-4 text-center">
              <p className="text-sm text-amber-900 font-medium">🚀 Launching Next Month!</p>
            </div>
          </div>
        </div>
      </section>
