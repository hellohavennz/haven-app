      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center">
          <button
            ...
            className="flex items-center px-6 py-3 bg-white hover:bg-gray-50 text-gray-800 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl border-2 border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
