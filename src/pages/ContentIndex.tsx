        ...
        <section className="mt-10">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {moduleSummaries.map(({
              ...
              <div
                key={module.slug}
                className={`flex h-full flex-col justify-between rounded-3xl border bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg dark:bg-slate-900/70 dark:shadow-gray-900/30 ${
                  isLocked
              ...
              >
                <div className="space-y-5">
                  ...
                  {nextUpLesson && (
                    <div className="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800">
                      <p className="text-small uppercase tracking-widest text-slate-500 dark:text-slate-400">
                        Next up
                      </p>
                      <p className="mt-1 text-sm text-slate-900 dark:text-gray-100">
                        {nextUpLesson.title}
                      </p>
                      <div className="mt-3 flex flex-wrap items-center gap-3 text-small font-medium text-slate-500 dark:text-slate-300">
                        <span className="inline-flex items-center gap-1 rounded-full bg-white px-3 py-1 shadow-sm dark:bg-slate-900">
                ...
                <div className="mt-6 flex items-center justify-between">
                  {isLocked ? (
                    <Link
                      to="/paywall"
                      className="group inline-flex items-center gap-2 text-sm font-semibold text-slate-600 transition hover:text-teal-600 dark:text-slate-300"
                    >
                  ...
                  <span className="text-small uppercase tracking-widest text-slate-400 dark:text-slate-500">
                    Module {module.order + 1}
                  </span>
                </div>
              </div>
