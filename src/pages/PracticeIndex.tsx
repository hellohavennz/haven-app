          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            ...
            {nextLesson && (
              <Link
                ...
                className="group inline-flex items-center gap-3 rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-sky-700 shadow-md transition hover:text-cyan-700"
              >
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {moduleSummaries.map((summary) => {
              ...
              return (
                <article
                  key={module.slug}
                  className={`group relative overflow-hidden rounded-3xl border bg-white p-6 shadow-sm transition hover:shadow-lg ${isLocked ? 'border-gray-200 opacity-75' : 'border-slate-200'}`}
                >
                  <div className={`absolute inset-x-0 top-0 h-1.5 ${isLocked ? 'bg-gray-300' : 'bg-gradient-to-r from-sky-400 via-sky-500 to-cyan-400'}`} />
                  <div className="space-y-4">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className={`flex h-12 w-12 items-center justify-center rounded-xl ${isLocked ? 'bg-gray-100 text-gray-400' : 'bg-slate-100 text-slate-500'}`}>
                    ...
                    {isLocked ? (
                      <div className="rounded-2xl bg-gray-50 p-6">
                        <div className="text-center">
                          ...
                          <p className="font-semibold text-gray-700 mb-2">Module Locked</p>
                        ...
                        <div className="rounded-2xl bg-slate-50 p-4">
                          ...
                          {nextUpLesson && summary.callToActionLabel && (
                            <Link
                              ...
                              className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-sky-600 transition hover:text-cyan-600"
                            >
