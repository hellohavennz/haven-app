        ...
        return (
          <section key={m.slug} className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {lessons.map(l => (
                <div key={l.id} className="group bg-gradient-to-br from-white to-gray-50 border-2 border-gray-200 rounded-2xl p-6 hover:border-teal-300 transition-all duration-200">
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      <Link
                        to={`/practice/${l.id}`}
                        className="flex-1 px-4 py-3 rounded-xl bg-gradient-to-r from-teal-600 to-teal-700 text-white font-semibold text-center hover:opacity-90 transition-all active:scale-95"
                      >
                        Questions
                      </Link>
                      <Link
