...
export default function Privacy() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 space-y-8 text-slate-700 dark:text-slate-300">
      <div>
        <h1 className="font-semibold text-slate-900 dark:text-white mb-2">Privacy Policy</h1>
      ...
      <section className="space-y-3">
        <h2 className="font-semibold text-slate-900 dark:text-white">4. Data retention</h2>
      ...
      <section className="space-y-3">
        <h2 className="font-semibold text-slate-900 dark:text-white">5. Your rights (UK GDPR)</h2>
      ...
      <section className="space-y-3">
        <h2 className="font-semibold text-slate-900 dark:text-white">6. Cookies</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="font-semibold text-slate-900 dark:text-white">7. Changes to this policy</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="font-semibold text-slate-900 dark:text-white">8. Contact</h2>
        <p className="text-sm">
