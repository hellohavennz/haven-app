    ...
    <div className="max-w-4xl mx-auto px-4 py-8 pb-32 md:pb-8">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 md:hidden z-40">
        <div className="flex gap-3 max-w-4xl mx-auto">
          ...
          <Link
            to={`/practice/${data.id}`}
            className="flex-1 px-6 py-4 rounded-xl bg-gradient-to-r from-teal-600 to-teal-700 text-white font-semibold hover:opacity-90 transition-all text-center active:scale-95 shadow-lg shadow-teal-200"
          >
            Practice
          </Link>
        </div>
      ...
      <div className="hidden md:flex gap-4 mt-12 justify-center">
        ...
        <Link
          to={`/practice/${data.id}`}
          className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-teal-600 to-teal-700 text-white font-semibold hover:opacity-90 transition-all active:scale-95 shadow-lg shadow-teal-200"
        >
