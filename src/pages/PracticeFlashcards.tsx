        ...
        {card ? (
          <div className="space-y-8">
            <div
              ...
              className={`relative h-96 rounded-3xl shadow-2xl cursor-pointer flex items-center justify-center p-8 transition-all duration-300 ${
                reveal
            ...
            >
              <div className="text-center space-y-6">
                ...
                <div className="text-sm text-teal-100 pt-4 font-medium">
                  {reveal ? "Auto-advancing in 2s..." : "Tap to reveal →"}
                </div>
              </div>
            </div>
