...
export default function Home() {
  ...
  return (
    <div className="space-y-20 text-slate-900 dark:text-gray-100 bg-white dark:bg-gray-950">
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-50 via-white to-emerald-50 px-6 py-16 dark:from-gray-900 dark:via-slate-950 dark:to-emerald-950 md:px-12 md:py-20">
        ...
        <div className="relative grid gap-12 lg:grid-cols-2 items-center">
          <div className="space-y-6">
            ...
            <h1 className="font-semibold leading-tight tracking-tight text-slate-900 dark:text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                to="/practice"
                className="inline-flex items-center justify-center gap-2 rounded-xl border-2 border-slate-300 bg-white px-6 py-3.5 text-slate-700 transition-all hover:border-slate-400 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-gray-100 dark:hover:border-slate-500 dark:hover:bg-slate-800"
              >
                Try Practice Quiz
              </Link>
            </div>
            ...
            <div className="flex items-center gap-6 pt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-slate-600 dark:text-slate-300">No credit card required</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="h-5 w-5 text-emerald-600" />
                <span className="text-sm text-slate-600 dark:text-slate-300">2 modules free</span>
              </div>
            </div>
          </div>
      ...
      <section className="grid gap-6 md:grid-cols-3">
        <div className="rounded-2xl bg-gradient-to-br from-teal-50 to-emerald-50 p-6 text-center dark:from-teal-900/30 dark:to-emerald-900/30">
          ...
          <div className="text-sm font-semibold text-slate-700 dark:text-slate-200">Comprehensive Lessons</div>
          <div className="mt-1 text-xs text-slate-600 dark:text-slate-400">Complete study materials</div>
        </div>
        ...
        <div className="rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 p-6 text-center dark:from-emerald-900/30 dark:to-teal-900/30">
          ...
          <div className="text-sm font-semibold text-slate-700 dark:text-slate-200">Haven User Pass Rate</div>
          <div className="mt-1 text-xs text-slate-600 dark:text-slate-400">Above national average</div>
        </div>
        ...
        <div className="rounded-2xl bg-gradient-to-br from-sky-50 to-teal-50 p-6 text-center dark:from-sky-900/30 dark:to-teal-900/30">
          ...
          <div className="text-sm font-semibold text-slate-700 dark:text-slate-200">Student Rating</div>
          <div className="mt-1 text-xs text-slate-600 dark:text-slate-400">From 12,000+ reviews</div>
        </div>
      </section>

      <section>
        <div className="mb-8 text-center">
          <h2 className="font-semibold text-slate-900 dark:text-white">Everything You Need to Pass</h2>
          <p className="mt-2 text-slate-600 dark:text-slate-300">Comprehensive study tools designed for success</p>
        </div>

        <div className="grid gap-6 md:grid-cols-3">
          <div className="group rounded-2xl border border-slate-200 bg-white p-6 transition-all hover:border-teal-300 hover:shadow-lg dark:border-slate-800 dark:bg-slate-900/70">
            ...
            <h3 className="mb-2 font-semibold text-slate-900 dark:text-gray-100">Clear Lessons</h3>
          ...
          <div className="group rounded-2xl border border-slate-200 bg-white p-6 transition-all hover:border-teal-300 hover:shadow-lg dark:border-slate-800 dark:bg-slate-900/70">
            ...
            <h3 className="mb-2 font-semibold text-slate-900 dark:text-gray-100">Smart Practice</h3>
            <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
          ...
          <div className="group rounded-2xl border border-slate-200 bg-white p-6 transition-all hover:border-teal-300 hover:shadow-lg dark:border-slate-800 dark:bg-slate-900/70">
            ...
            <h3 className="mb-2 font-semibold text-slate-900 dark:text-gray-100">Quick Review</h3>
            <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
        ...
        <div className="mx-auto max-w-3xl text-center space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 pt-8">
            <div className="rounded-2xl bg-white/10 p-6 text-left backdrop-blur">
              ...
              <p className="text-sm text-slate-300">Learn key facts with clear explanations and memory hooks</p>
            </div>
            ...
            <div className="rounded-2xl bg-white/10 p-6 text-left backdrop-blur">
              ...
              <p className="text-sm text-slate-300">Test your knowledge with realistic exam-style questions</p>
            </div>
            ...
            <div className="rounded-2xl bg-white/10 p-6 text-left backdrop-blur">
              ...
              <p className="text-sm text-slate-300">Reinforce learning with quick spaced repetition</p>
            </div>
            ...
            <div className="rounded-2xl bg-white/10 p-6 text-left backdrop-blur">
              ...
              <p className="text-sm text-slate-300">Verify your readiness with a full practice test</p>
            </div>
          </div>
        </div>
      </section>

      <section className="rounded-3xl border border-slate-200 bg-white p-8 text-center md:p-12 dark:border-slate-800 dark:bg-slate-900/70">
